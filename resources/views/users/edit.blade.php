@extends('layouts/.admin')
    ...
    <form action="{{ route('user-update',['user'=>$user->id]) }}" method="POST" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="email" name="email" class="form-control" id="email" value="{{ old('email',$user->email) }}" placeholder="Email do usuario">
        </div>
        <div class="col-md-6">
            <label for="password" class="form-label">senha:</label>
            <input type="password" name="password" class="form-control" id="password" placeholder="Digite sua senha" value="{{ old('password') }}">
        </div>
        <div class="col-md-6">
